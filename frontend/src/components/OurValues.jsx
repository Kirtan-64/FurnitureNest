    ...
    <div className="flex flex-col lg:flex-row">
      <div className="w-full p-4 text-left lg:w-1/3">
        ...
        <p className="my-5 text-gray-600">
          {" "}
          Distinctio assumenda tenetur sequi, nemo, error illum dolorem dolor
          voluptatum beatae dignissimos nulla dolores delectus similique
          blanditiis praesentium deserunt?
        </p>
      </div>
      <div className="w-full p-4 text-left lg:w-1/3">
        <hr className="mb-4 h-1.5 w-1/4 bg-blue-600" />
        ...
        <p className="my-5 text-gray-600">
          Deleniti earum nulla repudiandae esse delectus. Dolorem, hic animi sit
          pariatur ducimus commodi tempore.
        </p>
      </div>
      <div className="w-full p-4 text-left lg:w-1/3">
        <hr className="mb-4 h-1.5 w-1/4 bg-blue-600" />
        ...
        <p className="my-5 text-gray-600">
          ...
          aperiam. Molestias corporis numquam quos dolorem culpa ullam ad. Ipsa
          quidem excepturi mollitia? Expedita, sequi?
        </p>
      </div>
    </div>
  </div>
